...
1. 首页收藏和专题支持切换卡片样式或者列表样式
2. 文章分享链接支持临时分享临时链接，临时链接的有效期为 3 小时(#27)。
3. 服务端部署时增加配置项日志。
4. 【网页端】支持登录，支持非公开文章的查看，支持查看编辑计划安排，待办事项，便签。相关功能主要适配移动端。
5. 【网页端】增加了一些样式配置。
6. 全新的[官方文档](https://www.wangyunf.com/blossom-doc/index.html)。
